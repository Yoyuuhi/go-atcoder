...
func main() {
	...
	for i := 1; i < len(s); i++ {
		...
		case "c":
			mem[i+1][0] += 1
			mem[i+1][0] %= mod1000000007
		case "h":
			mem[i+1][1] += mem[i][0]
			mem[i+1][1] %= mod1000000007
		case "o":
			mem[i+1][2] += mem[i][1]
			mem[i+1][2] %= mod1000000007
		case "k":
			mem[i+1][3] += mem[i][2]
			mem[i+1][3] %= mod1000000007
		case "u":
			mem[i+1][4] += mem[i][3]
			mem[i+1][4] %= mod1000000007
		case "d":
			mem[i+1][5] += mem[i][4]
			mem[i+1][5] %= mod1000000007
		case "a":
			mem[i+1][6] += mem[i][5]
			mem[i+1][6] %= mod1000000007
		case "i":
			mem[i+1][7] += mem[i][6]
			mem[i+1][7] %= mod1000000007
		}

		for j := 0; j < 8; j++ {
			mem[i+1][j] += mem[i][j]
			mem[i+1][j] %= mod1000000007
		}
	}
