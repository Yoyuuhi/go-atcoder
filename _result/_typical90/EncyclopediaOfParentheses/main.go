...
func printParentheses(str string, leftCount, rightCount, n int) {
	if len(str) == n {
	...
	if (leftCount - rightCount) <= (n - len(str)) {
		str1 := str + "("
		printParentheses(str1, leftCount+1, rightCount, n)
	}

	if leftCount > rightCount {
		str2 := str + ")"
		printParentheses(str2, leftCount, rightCount+1, n)
	}
}
