...
func main() {
	...
	ans := 10 * 9 / 2
	for i := 2; i < len(itoa(n)); i++ {
		tens := 1
		for len(itoa(tens)) != i+1 {
			tens *= 10
		}
		ans += ((1 + tens - tens/10) % mod998244353) * (((tens - tens/10) / 2) % mod998244353)
		ans %= mod998244353
	}
	tens := 1
	for len(itoa(tens)) != len(itoa(n)) {
		tens *= 10
	}
	if (1+n-tens+1)%2 == 0 {
		ans += (1 + n - tens + 1) / 2 % mod998244353 * ((n - tens + 1) % mod998244353)
	} else {
		ans += (1 + n - tens + 1) % mod998244353 * ((n - tens + 1) / 2 % mod998244353)
	}
