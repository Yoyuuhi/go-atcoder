...
func main() {
	...
	for i := 0; i < len(s); i++ {
		dp[i+1][0] = madd(dp[i+1][0], dp[i][0])
		dp[i+1][1] = madd(dp[i+1][1], dp[i][1])
		dp[i+1][2] = madd(dp[i+1][2], dp[i][2])
		dp[i+1][3] = madd(dp[i+1][3], dp[i][3])

		c := string(s[i])
		switch c {
		case "A":
			dp[i+1][1] = madd(dp[i+1][1], dp[i][0])
		case "B":
			dp[i+1][2] = madd(dp[i+1][2], dp[i][1])
		case "C":
			dp[i+1][3] = madd(dp[i+1][3], dp[i][2])
		default:
			dp[i+1][1] = madd(dp[i+1][1], dp[i][0])
			dp[i+1][2] = madd(dp[i+1][2], dp[i][1])
			dp[i+1][3] = madd(dp[i+1][3], dp[i][2])
			dp[i+1][0] = madd(dp[i+1][0], 2*dp[i][0])
			dp[i+1][1] = madd(dp[i+1][1], 2*dp[i][1])
			dp[i+1][2] = madd(dp[i+1][2], 2*dp[i][2])
			dp[i+1][3] = madd(dp[i+1][3], 2*dp[i][3])
		}
	}
