...
func main() {
	...
	x := ((a % mod998244353) * (b % mod998244353)) % mod998244353
	x = (x * (c % mod998244353)) % mod998244353
	y := ((d % mod998244353) * (e % mod998244353)) % mod998244353
	y = (y * (f % mod998244353)) % mod998244353

	ans := (x - y) % mod998244353
	if ans < 0 {
		ans += mod998244353
	}
	out(ans)
